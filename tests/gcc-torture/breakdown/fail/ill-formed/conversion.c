...
#if __GNUC__
float 
ull2f (unsigned long long int u)
{
  return u;
}

double 
ull2d (unsigned long long int u)
{
  return u;
}

long double 
ull2ld (unsigned long long int u)
{
  return u;
}

float 
sll2f (long long int s)
{
  return s;
}

double 
sll2d (long long int s)
{
  return s;
}

long double 
sll2ld (long long int s)
{
  return s;
}

int 
test_longlong_integer_to_float (void)
{
...
int 
test_float_to_longlong_integer (void)
{
  if (f2ull(0.0) != 0LL)
    abort();
  if (f2ull(0.999) != 0LL)

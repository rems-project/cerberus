  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        Hacl_Bignum_Crecip_crecip_(x30, x21);
        KRML_CHECK_SIZE(sizeof (FStar_UInt128_uint128), (uint32_t)5U);
        FStar_UInt128_uint128 tmp10[5U];
        for (uint32_t _i = 0U; _i < (uint32_t)5U; ++_i)
          tmp10[_i] = FStar_UInt128_uint64_to_uint128((uint64_t)0U);
        memcpy(t00, x30, (uint32_t)5U * sizeof x30[0U]);
        Hacl_Bignum_Fsquare_fsquare_(tmp10, t00);
        memcpy(t10, x21, (uint32_t)5U * sizeof x21[0U]);
        Hacl_Bignum_fdifference(t10, t00);
        uint64_t t01 = t10[0U];
        uint64_t t110 = t10[1U];
        uint64_t t20 = t10[2U];
        uint64_t t30 = t10[3U];
        uint64_t t40 = t10[4U];
        uint64_t t1_ = t110 + (t01 >> (uint32_t)51U);
        uint64_t t0_ = t01 & (uint64_t)0x7ffffffffffffU;
        uint64_t t2_ = t20 + (t1_ >> (uint32_t)51U);
        uint64_t t1__ = t1_ & (uint64_t)0x7ffffffffffffU;
        uint64_t t3_ = t30 + (t2_ >> (uint32_t)51U);
        uint64_t t2__ = t2_ & (uint64_t)0x7ffffffffffffU;
        ...
        t10[3U] = t3__;
        t10[4U] = t4_;
        Hacl_Bignum_Modulo_carry_top(t10);
        uint64_t i0 = t10[0U];
        uint64_t i10 = t10[1U];
        uint64_t i0_ = i0 & (uint64_t)0x7ffffffffffffU;
        uint64_t i1_ = i10 + (i0 >> (uint32_t)51U);
        ...
        if (!t1_is_0)
        {
          ...
          Hacl_Bignum_fmul(x30, x30, sqrt_m1);
        }
        Hacl_EC_Format_reduce(x30);
        uint64_t *x210 = tmp;
        ...
        memcpy(t02, x31, (uint32_t)5U * sizeof x31[0U]);
        Hacl_Bignum_Fsquare_fsquare_(tmp1, t02);
        memcpy(t12, x210, (uint32_t)5U * sizeof x210[0U]);
        Hacl_Bignum_fdifference(t12, t02);
        uint64_t t010 = t12[0U];
        uint64_t t11 = t12[1U];
        uint64_t t21 = t12[2U];
        uint64_t t31 = t12[3U];
        uint64_t t41 = t12[4U];
        uint64_t t1_0 = t11 + (t010 >> (uint32_t)51U);
        ...
        bool z1 = Hacl_Impl_Ed25519_RecoverX_is_0(t12);
        bool ite;
        if (z1 == false)
          ite = false;
        else
        {
          ...
          if (!(x00 == sign1))
          {
            ...
            uint64_t t3 = x3[3U];
            uint64_t t4 = x3[4U];
            uint64_t t1_ = t1 + (t01 >> (uint32_t)51U);
            uint64_t t0_ = t01 & (uint64_t)0x7ffffffffffffU;
            uint64_t t2_ = t2 + (t1_ >> (uint32_t)51U);
            uint64_t t1__ = t1_ & (uint64_t)0x7ffffffffffffU;
            uint64_t t3_ = t3 + (t2_ >> (uint32_t)51U);
...
static bool Hacl_Impl_Ed25519_PointDecompress_point_decompress(uint64_t *out, uint8_t *s)
{
  ...
  bool z0 = Hacl_Impl_Ed25519_RecoverX_recover_x(x1, y1, sign1);
  bool z1 = z0;
  bool res;
  if (z1 == false)
    res = false;
...
static void Hacl_Impl_SHA2_512_update_last(uint64_t *state, uint8_t *data, uint32_t len1)
{
  ...
  uint8_t *padding = final_blocks + len1;
  FStar_UInt128_uint128
  l0 = FStar_UInt128_mul_wide((uint64_t)(uint32_t)n1, (uint64_t)(uint32_t)128U);
  FStar_UInt128_uint128 l1 = FStar_UInt128_uint64_to_uint128((uint64_t)len1);
  FStar_UInt128_uint128
  encodedlen = FStar_UInt128_shift_left(FStar_UInt128_add(l0, l1), (uint32_t)3U);
  uint32_t pad0len = ((uint32_t)256U - (len1 + (uint32_t)16U + (uint32_t)1U)) % (uint32_t)128U;
...
Hacl_Impl_Ed25519_PointDouble_point_double_(uint64_t *out, uint64_t *p10, uint64_t *tmp)
{
  ...
  uint64_t t0 = tmp21[0U];
  uint64_t t10 = tmp21[1U];
  uint64_t t20 = tmp21[2U];
  uint64_t t310 = tmp21[3U];
  uint64_t t40 = tmp21[4U];
  uint64_t t1_ = t10 + (t0 >> (uint32_t)51U);
  uint64_t t0_ = t0 & (uint64_t)0x7ffffffffffffU;
  uint64_t t2_ = t20 + (t1_ >> (uint32_t)51U);
  uint64_t t1__ = t1_ & (uint64_t)0x7ffffffffffffU;
  uint64_t t3_ = t310 + (t2_ >> (uint32_t)51U);
  uint64_t t2__ = t2_ & (uint64_t)0x7ffffffffffffU;
  uint64_t t4_ = t40 + (t3_ >> (uint32_t)51U);
  uint64_t t3__ = t3_ & (uint64_t)0x7ffffffffffffU;
  tmp21[0U] = t0_;
  ...
  uint64_t i0 = tmp21[0U];
  uint64_t i10 = tmp21[1U];
  uint64_t i0_ = i0 & (uint64_t)0x7ffffffffffffU;
  uint64_t i1_ = i10 + (i0 >> (uint32_t)51U);
  tmp21[0U] = i0_;
  tmp21[1U] = i1_;
  uint64_t t00 = tmp41[0U];
  uint64_t t1 = tmp41[1U];
  uint64_t t2 = tmp41[2U];
  uint64_t t31 = tmp41[3U];
  uint64_t t4 = tmp41[4U];
  ...
  uint64_t i00 = tmp41[0U];
  uint64_t i1 = tmp41[1U];
  uint64_t i0_0 = i00 & (uint64_t)0x7ffffffffffffU;
  uint64_t i1_0 = i1 + (i00 >> (uint32_t)51U);
  tmp41[0U] = i0_0;
  tmp41[1U] = i1_0;
...
static void Hacl_Impl_Ed25519_Ladder_Step_loop_step(uint64_t *b, uint8_t *k1, uint32_t ctr)
{
  ...
  Hacl_Impl_Ed25519_SwapConditional_swap_conditional_inplace(nq1, nqpq10, bit10);
  uint64_t *nq10 = b;
  uint64_t *nqpq11 = b + (uint32_t)20U;
  uint64_t *nq210 = b + (uint32_t)40U;
  uint64_t *nqpq210 = b + (uint32_t)60U;
  Hacl_Impl_Ed25519_PointDouble_point_double(nq210, nq10);
  uint64_t tmp[30U] = { 0U };
  uint64_t *tmp1 = tmp;
  uint64_t *tmp20 = tmp + (uint32_t)5U;
  uint64_t *tmp30 = tmp + (uint32_t)10U;
  uint64_t *tmp40 = tmp + (uint32_t)15U;
  uint64_t *x1 = Hacl_Impl_Ed25519_ExtPoint_getx(nq10);
  uint64_t *y1 = Hacl_Impl_Ed25519_ExtPoint_gety(nq10);
  ...
  Hacl_Bignum_fdifference(tmp1, y1);
  uint64_t t00 = tmp1[0U];
  uint64_t t10 = tmp1[1U];
  uint64_t t20 = tmp1[2U];
  uint64_t t30 = tmp1[3U];
  uint64_t t40 = tmp1[4U];
  uint64_t t1_ = t10 + (t00 >> (uint32_t)51U);
  uint64_t t0_ = t00 & (uint64_t)0x7ffffffffffffU;
  uint64_t t2_ = t20 + (t1_ >> (uint32_t)51U);
  uint64_t t1__ = t1_ & (uint64_t)0x7ffffffffffffU;
  ...
  tmp1[3U] = t3__;
  tmp1[4U] = t4_;
  Hacl_Bignum_Modulo_carry_top(tmp1);
  uint64_t i0 = tmp1[0U];
  uint64_t i10 = tmp1[1U];
  uint64_t i0_ = i0 & (uint64_t)0x7ffffffffffffU;
  uint64_t i1_ = i10 + (i0 >> (uint32_t)51U);
  tmp1[0U] = i0_;
  tmp1[1U] = i1_;
  Hacl_Bignum_fdifference(tmp20, y2);
  Hacl_Bignum_fmul(tmp30, tmp1, tmp20);
  memcpy(tmp1, y1, (uint32_t)5U * sizeof y1[0U]);
  memcpy(tmp20, y2, (uint32_t)5U * sizeof y2[0U]);
  Hacl_Bignum_fsum(tmp1, x1);
  Hacl_Bignum_fsum(tmp20, x2);
  Hacl_Bignum_fmul(tmp40, tmp1, tmp20);
  uint64_t *tmp10 = tmp;
  uint64_t *tmp21 = tmp + (uint32_t)5U;
  uint64_t *tmp31 = tmp + (uint32_t)10U;
  uint64_t *tmp50 = tmp + (uint32_t)20U;
  uint64_t *tmp60 = tmp + (uint32_t)25U;
  uint64_t *z1 = Hacl_Impl_Ed25519_ExtPoint_getz(nq10);
  uint64_t *t11 = Hacl_Impl_Ed25519_ExtPoint_gett(nq10);
  uint64_t *z2 = Hacl_Impl_Ed25519_ExtPoint_getz(nqpq11);
  uint64_t *t21 = Hacl_Impl_Ed25519_ExtPoint_gett(nqpq11);
  uint64_t d2[5U] = { 0U };
  ...
  Hacl_Bignum_fmul(tmp10, t11, d2);
  Hacl_Bignum_fmul(tmp21, tmp10, t21);
  uint64_t a0 = z1[0U];
  uint64_t a1 = z1[1U];
  uint64_t a2 = z1[2U];
  uint64_t a3 = z1[3U];
  ...
  tmp10[3U] = o3;
  tmp10[4U] = o4;
  Hacl_Bignum_fmul(tmp50, tmp10, z2);
  ...
  uint64_t *tmp51 = tmp + (uint32_t)20U;
  uint64_t *tmp61 = tmp + (uint32_t)25U;
  Hacl_Bignum_fdifference(tmp11, tmp41);
  uint64_t t0 = tmp11[0U];
  uint64_t t1 = tmp11[1U];
  uint64_t t2 = tmp11[2U];
  uint64_t t31 = tmp11[3U];
  uint64_t t4 = tmp11[4U];
  uint64_t t1_0 = t1 + (t0 >> (uint32_t)51U);
  uint64_t t0_0 = t0 & (uint64_t)0x7ffffffffffffU;
  uint64_t t2_0 = t2 + (t1_0 >> (uint32_t)51U);
  uint64_t t1__0 = t1_0 & (uint64_t)0x7ffffffffffffU;
  uint64_t t3_0 = t31 + (t2_0 >> (uint32_t)51U);
  uint64_t t2__0 = t2_0 & (uint64_t)0x7ffffffffffffU;
  ...
  tmp11[3U] = t3__0;
  tmp11[4U] = t4_0;
  Hacl_Bignum_Modulo_carry_top(tmp11);
  uint64_t i00 = tmp11[0U];
  uint64_t i1 = tmp11[1U];
  uint64_t i0_0 = i00 & (uint64_t)0x7ffffffffffffU;
  uint64_t i1_0 = i1 + (i00 >> (uint32_t)51U);
  tmp11[0U] = i0_0;
  tmp11[1U] = i1_0;
  ...
  uint64_t *tmp6 = tmp + (uint32_t)25U;
  uint64_t *x3 = Hacl_Impl_Ed25519_ExtPoint_getx(nqpq210);
  uint64_t *y3 = Hacl_Impl_Ed25519_ExtPoint_gety(nqpq210);
  uint64_t *z3 = Hacl_Impl_Ed25519_ExtPoint_getz(nqpq210);
  uint64_t *t3 = Hacl_Impl_Ed25519_ExtPoint_gett(nqpq210);
  Hacl_Bignum_fmul(x3, tmp12, tmp6);
  Hacl_Bignum_fmul(y3, tmp5, tmp4);
  Hacl_Bignum_fmul(t3, tmp12, tmp4);
  Hacl_Bignum_fmul(z3, tmp5, tmp6);
  uint64_t *nq11 = b;
  uint64_t *nqpq1 = b + (uint32_t)20U;
  uint64_t *nq21 = b + (uint32_t)40U;
  uint64_t *nqpq21 = b + (uint32_t)60U;
  uint64_t bit1 = (uint64_t)bit;
  Hacl_Impl_Ed25519_SwapConditional_swap_conditional(nq11, nqpq1, nq21, nqpq21, bit1);
}
...
)
{
  ...
  memcpy(tmp11, x1, (uint32_t)5U * sizeof x1[0U]);
  memcpy(tmp20, x2, (uint32_t)5U * sizeof x2[0U]);
  Hacl_Bignum_fdifference(tmp11, y1);
  uint64_t t00 = tmp11[0U];
  uint64_t t10 = tmp11[1U];
  uint64_t t20 = tmp11[2U];
  uint64_t t30 = tmp11[3U];
  uint64_t t40 = tmp11[4U];
  uint64_t t1_ = t10 + (t00 >> (uint32_t)51U);
  uint64_t t0_ = t00 & (uint64_t)0x7ffffffffffffU;
  uint64_t t2_ = t20 + (t1_ >> (uint32_t)51U);
  uint64_t t1__ = t1_ & (uint64_t)0x7ffffffffffffU;
  ...
  tmp11[4U] = t4_;
  Hacl_Bignum_Modulo_carry_top(tmp11);
  uint64_t i0 = tmp11[0U];
  uint64_t i10 = tmp11[1U];
  uint64_t i0_ = i0 & (uint64_t)0x7ffffffffffffU;
  uint64_t i1_ = i10 + (i0 >> (uint32_t)51U);
  tmp11[0U] = i0_;
  tmp11[1U] = i1_;
  Hacl_Bignum_fdifference(tmp20, y2);
  Hacl_Bignum_fmul(tmp30, tmp11, tmp20);
  memcpy(tmp11, y1, (uint32_t)5U * sizeof y1[0U]);
  memcpy(tmp20, y2, (uint32_t)5U * sizeof y2[0U]);
  Hacl_Bignum_fsum(tmp11, x1);
  Hacl_Bignum_fsum(tmp20, x2);
  Hacl_Bignum_fmul(tmp40, tmp11, tmp20);
  uint64_t *tmp110 = tmp1;
  uint64_t *tmp21 = tmp1 + (uint32_t)5U;
  uint64_t *tmp31 = tmp1 + (uint32_t)10U;
  uint64_t *tmp50 = tmp1 + (uint32_t)20U;
  uint64_t *tmp60 = tmp1 + (uint32_t)25U;
  uint64_t *z1 = Hacl_Impl_Ed25519_ExtPoint_getz(r_);
  uint64_t *t11 = Hacl_Impl_Ed25519_ExtPoint_gett(r_);
  uint64_t *z2 = Hacl_Impl_Ed25519_ExtPoint_getz(hA);
  uint64_t *t21 = Hacl_Impl_Ed25519_ExtPoint_gett(hA);
  uint64_t d2[5U] = { 0U };
  d2[0U] = (uint64_t)0x00069b9426b2f159U;
  d2[1U] = (uint64_t)0x00035050762add7aU;
  d2[2U] = (uint64_t)0x0003cf44c0038052U;
  d2[3U] = (uint64_t)0x0006738cc7407977U;
  d2[4U] = (uint64_t)0x0002406d9dc56dffU;
  Hacl_Bignum_fmul(tmp110, t11, d2);
  Hacl_Bignum_fmul(tmp21, tmp110, t21);
  uint64_t a0 = z1[0U];
  uint64_t a1 = z1[1U];
  uint64_t a2 = z1[2U];
  uint64_t a3 = z1[3U];
  ...
  tmp110[3U] = o3;
  tmp110[4U] = o4;
  Hacl_Bignum_fmul(tmp50, tmp110, z2);
  memcpy(tmp110, tmp31, (uint32_t)5U * sizeof tmp31[0U]);
  memcpy(tmp60, tmp21, (uint32_t)5U * sizeof tmp21[0U]);
  uint64_t *tmp111 = tmp1;
  uint64_t *tmp2 = tmp1 + (uint32_t)5U;
  uint64_t *tmp3 = tmp1 + (uint32_t)10U;
  uint64_t *tmp41 = tmp1 + (uint32_t)15U;
  uint64_t *tmp51 = tmp1 + (uint32_t)20U;
  uint64_t *tmp61 = tmp1 + (uint32_t)25U;
  Hacl_Bignum_fdifference(tmp111, tmp41);
  uint64_t t0 = tmp111[0U];
  uint64_t t1 = tmp111[1U];
  uint64_t t2 = tmp111[2U];
  uint64_t t31 = tmp111[3U];
  uint64_t t4 = tmp111[4U];
  uint64_t t1_0 = t1 + (t0 >> (uint32_t)51U);
  uint64_t t0_0 = t0 & (uint64_t)0x7ffffffffffffU;
  uint64_t t2_0 = t2 + (t1_0 >> (uint32_t)51U);
  uint64_t t1__0 = t1_0 & (uint64_t)0x7ffffffffffffU;
  ...
  tmp111[3U] = t3__0;
  tmp111[4U] = t4_0;
  Hacl_Bignum_Modulo_carry_top(tmp111);
  uint64_t i00 = tmp111[0U];
  uint64_t i1 = tmp111[1U];
  uint64_t i0_0 = i00 & (uint64_t)0x7ffffffffffffU;
  uint64_t i1_0 = i1 + (i00 >> (uint32_t)51U);
  tmp111[0U] = i0_0;
  tmp111[1U] = i1_0;
  ...
  Hacl_Bignum_fsum(tmp51, tmp2);
  Hacl_Bignum_fsum(tmp41, tmp3);
  uint64_t *tmp112 = tmp1;
  uint64_t *tmp4 = tmp1 + (uint32_t)15U;
  uint64_t *tmp5 = tmp1 + (uint32_t)20U;
  uint64_t *tmp6 = tmp1 + (uint32_t)25U;
  uint64_t *x3 = Hacl_Impl_Ed25519_ExtPoint_getx(rhA);
  uint64_t *y3 = Hacl_Impl_Ed25519_ExtPoint_gety(rhA);
  uint64_t *z3 = Hacl_Impl_Ed25519_ExtPoint_getz(rhA);
  uint64_t *t3 = Hacl_Impl_Ed25519_ExtPoint_gett(rhA);
  Hacl_Bignum_fmul(x3, tmp112, tmp6);
  Hacl_Bignum_fmul(y3, tmp5, tmp4);
  Hacl_Bignum_fmul(t3, tmp112, tmp4);
  Hacl_Bignum_fmul(z3, tmp5, tmp6);
...
static void Hacl_Impl_Ed25519_PointCompress_point_compress(uint8_t *z, uint64_t *p10)
{
  ...
  uint64_t b = Hacl_Impl_Ed25519_PointCompress_x_mod_2(x);
...
void Hacl_Ed25519_sign(uint8_t *signature, uint8_t *secret, uint8_t *msg, uint32_t len1)
{
  ...
  uint64_t *h4 = tmp_ints + (uint32_t)60U;
  uint8_t *a__0 = tmp_bytes + (uint32_t)96U;

...
\begin{proof}
    ...
    \step{<1>4}{%
        \case{%
            ...
            \pf\ We know $\cnkw{smt} \, \cnsym{(}  \Phi'  \Rightarrow  \cnkw{false}  \cnsym{)}$ and $\cnkw{smt} \, \cnsym{(}  \Phi  \Rightarrow  term  \cnsym{)}$ 
            for each $ term \in \Phi'$ so $\cnkw{smt} \, \cnsym{(}  \Phi  \Rightarrow  \cnkw{false}  \cnsym{)}$.
        }
    }
    ...
    \begin{proof}
        \step{<2>1}{By induction,
            \begin{pfenum}
                ...
                \item $\cnkw{smt} \, \cnsym{(}  \Phi  \Rightarrow   \sigma  \cnsym{,}  pval  \cnsym{/}  \cnmv{y}  \cnsym{,}  \cdot  (  \cnnt{term}  )   \cnsym{)}$.
            \end{pfenum}}

        \step{<2>2}{So $\mathcal{C}  \cnsym{;}  \mathcal{L}  \cnsym{;}  \Phi  \vdash   \sigma  (  \cnkw{done} \, pval  )   \Leftarrow  \cnmv{y}  {:}  \beta  . \:   \sigma  (  \cnnt{term}  ) $.}
    \end{proof}
    ...
    \begin{proof}
        \step{<2>1}{By induction,
            \begin{pfenum}
                ...
                \item $\cncomp{\mathcal{C}  \cnsym{,}  \mathcal{C}_{\cnmv{i}}  \cnsym{;}  \mathcal{L}  \cnsym{;}  \Phi  \cnsym{,}  term_{\cnmv{i}}  =   pval   \vdash   \sigma  (  tpexpr_{\cnmv{i}}  )   \Leftarrow  \cnmv{y_{{\mathrm{2}}}}  {:}  \beta_{{\mathrm{2}}}  . \:   \sigma  (  \cnnt{term_{{\mathrm{2}}}}  ) }{\cnmv{i}}$.
            \end{pfenum}}

        \step{<2>2}{$\mathcal{C}  \cnsym{;}  \mathcal{L}  \cnsym{;}  \Phi  \vdash   \sigma  (  \cnkw{case} \, pval \, \cnkw{of} \, \cncomp{\mid  pattern_{\cnmv{i}}  \Rightarrow  tpexpr_{\cnmv{i}}}{\cnmv{i}} \, \cnkw{end}  )   \Leftarrow  \cnmv{y_{{\mathrm{2}}}}  {:}  \beta_{{\mathrm{2}}}  . \:   \sigma  (  \cnnt{term_{{\mathrm{2}}}}  ) $.}
    \end{proof}
    ...
    \step{<1>17}{%
        \case{%
            ...
            \pf\ By induction. Rules with SMT checks still hold because the
            same substitution is applied to the constraint context and the
            consequent.
        }
    }
    ...
    \begin{proof}
        ...
        \step{<2>2}{$\cnkw{smt} \, \cnsym{(}  \Phi'  \Rightarrow   \sigma  (  \cnnt{term}  )   \cnsym{)}$.\\
            \pf\ We $\cnkw{smt} \, \cnsym{(}  \Phi'  \Rightarrow  \cnnt{term}  \cnsym{)}$, which means it is true for
            all (well-typed) instantiations of its free variables.}

        \step{<2>3}{$\cnkw{smt} \, \cnsym{(}  \Phi  \Rightarrow   \sigma  (  \cnnt{term}  )   \cnsym{)}$.\\
            \pf\ From $ \Phi \Rightarrow \Phi' $ and \stepref{<2>2}.}

        \step{<2>4}{$\mathcal{C}  \cnsym{;}  \mathcal{L}  \cnsym{;}  \Phi  \cnsym{;}  \mathcal{R}  \vdash \, \cncomp{\cnmv{x_{\cnmv{i}}}  =   \sigma  (  \cnnt{spine\_elem_{\cnmv{i}}}  ) }{\cnmv{i}} \, \mathbin{ {:} {:} }   \sigma  (   term  \supset  \cnnt{arg}   )   \gg   \sigma  (  \psi  )   \cnsym{;}   \sigma  (  \cnnt{ret}  ) $ as required.}
    \end{proof}
    ...
    %         \item $\mathcal{C}  \cnsym{,}  \mathcal{C}_{{\mathrm{1}}}  \cnsym{;}  \mathcal{L}  \cnsym{;}  \Phi  \cnsym{,}   term  \cnsym{/}  \cnmv{y_{{\mathrm{1}}}}  \cnsym{,}  \sigma  (  \cnnt{term_{{\mathrm{1}}}}  )   \vdash   \sigma  (  tpexpr  )   \Leftarrow  \cnmv{y_{{\mathrm{2}}}}  {:}  \beta_{{\mathrm{2}}}  . \:   \sigma  (  \cnnt{term_{{\mathrm{2}}}}  ) $.
    %     \end{pfenum}}

...
\begin{proof}
    ...
    \step{<1>12}{%
        \case{%
            ...
            $\mathcal{C}'  \cnsym{;}  \mathcal{L}'  \cnsym{;}  \Phi'  \cnsym{;}  \cdot  \cnsym{,}  \cnnt{pt}  \vdash  \cnnt{pt'}  \Leftarrow  \cnnt{pt''}$.
    ...
    \step{<2>1}{Since $\mathcal{R}' = \cdot  \cnsym{,}  \cnnt{pt}$, $\sigma$ was
        derived using \textsc{Ty\_Subs\_Cons\_Res\_Anon}.}
    ...
    \step{<2>6}{$\Phi  \vdash  \cnnt{pt_{{\mathrm{3}}}} \, \equiv \,  \sigma  (  \cnnt{pt}  ) $ by inversion on \stepref{<2>7}.}
...
\begin{proof}
    ...
    \begin{proof}
        ...
        \step{<2>3}{$term_{\cnmv{j}}  =   pval $.\\
            \pf\ By \stepref{<1>32}.2 and terms derived from patterns are
        ...
        \step{<2>5}{By \stepref{<2>4}, \stepref{<1>32}.3 and substitution lemma

...
\begin{proof}
    \assume{%
        ...
        % FIXME update proof for predicates
        \item $\mathcal{L}  \cnsym{;}  \Phi  \vdash  \cnnt{res\_pattern}  {:}  \cnnt{res}  \leadsto  \mathcal{L}'  \cnsym{;}  \Phi'  \cnsym{;}  \mathcal{R}'$.\label{wt_sub_res-assm2}
...
\begin{proof}
    ...
    \assume{%
        \begin{pfenum}
            ...
            % FIXME update proof for predicates
            \item $\mathcal{L}  \cnsym{;}  \Phi  \vdash \, \cncomp{\cnnt{ret\_pattern_{\cnmv{i}}}}{\cnmv{i}} \, {:}  \cnnt{ret}  \leadsto  \mathcal{C}  \cnsym{;}  \mathcal{L}'  \cnsym{;}  \Phi'  \cnsym{;}  \mathcal{R}'$.\label{wt_sub-assm3}
        \end{pfenum}
    }
...
\begin{proof}
    ...
    \begin{proof}
        \step{<2>1}{$\mathcal{R} = \cdot  \cnsym{,}  \cnmv{\_}  {:}  \cnnt{pt_{{\mathrm{2}}}}$ where $\cdot  \vdash  \cnnt{pt''} \, \equiv \, \cnnt{pt}$,
    ...
    \begin{proof}
        \step{<2>1}{\begin{pfenum}
                ...
                % FIXME update proof for predicates
                \item $\mathcal{L}  \cnsym{;}  \Phi  \vdash \, \cncomp{\cnnt{ret\_pattern_{\cnmv{i}}}}{\cnmv{i}} \, {:}  \cnnt{ret_{{\mathrm{1}}}}  \leadsto  \mathcal{C}_{{\mathrm{1}}}  \cnsym{;}  \mathcal{L}_{{\mathrm{1}}}  \cnsym{;}  \Phi_{{\mathrm{1}}}  \cnsym{;}  \mathcal{R}_{{\mathrm{1}}}$.

...
\begin{proof}
    ...
    \begin{proof}
        ...
        \step{<2>1}{$\mathcal{R} = \mathcal{R}'$.\\
            \pf\ Only \textsc{Weak\_Cons\_Res\_\{Anon,Named\}} exist, no
            \textsc{Weak\_Skip\_Res}.}
...
\begin{proof}
    ...
    \begin{proof}
        \step{<2>1}{$\mathcal{R} = \cdot  \cnsym{,}  \cnnt{pt'}$ where $\cdot  \vdash  \cnnt{pt'} \, \equiv \, \cnnt{pt}$
    ...
    \begin{proof}
        \step{<2>1}{$\mathcal{R} = \cdot  \cnsym{,}  \cnnt{pt_{{\mathrm{2}}}}$ where $\cdot  \vdash  \cnnt{pt''} \, \equiv \, \cnnt{pt}$,
        ...
        \step{<2>3}{$\cdot  \cnsym{;}  \cdot  \cnsym{;}  \cdot  \cnsym{;}  \cdot  \cnsym{,}  \cnnt{pt'}  \vdash  \cnnt{pt'}  \Leftarrow  \cnnt{pt'}$
    ...
    \step{<1>17}{%
        \case{%
            ...
            Note: $\mathcal{R} = \cdot  \cnsym{,}  \cnnt{pt'}$ where $\cdot  \vdash  \cnnt{pt'} \, \equiv \, \cnnt{pt}$.
        }
    }

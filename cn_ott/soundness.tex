...
either $\mathrm{value}(e)$, or it is unreachable, or $\forall h : R.\ \exists
e' , h' .\ \hconf{h}{e} \stepsto \hconf{h'}{e'}$.
...
\begin{proof}
    ...
    \prove{%
        Either $\mathrm{value}(e)$, or it is unreachable, or $\forall h : R.\
    ...
    \step{<1>29}{%
        \case{%
            ...
            \pf\ We have to show that assuming the case-expression is
            well-typed, then there is at least one pattern against
            which $pval$ will match.
            % ASK
        }
    }
...
\begin{proof}
    ...
    \begin{proof}
        ...
        \step{<2>5}{By \stepref{<1>32}.3 and \ref{subsec:sub_lemma}, we are done.}

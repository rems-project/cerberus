...
val provable : Memory.struct_decls -> Z3.Solver.solver -> LogicalConstraints.t -> [> `True | `False ]
val provable_or_model : Memory.struct_decls -> Z3.Solver.solver -> LogicalConstraints.t -> [> `True | `False of Z3.Model.model]

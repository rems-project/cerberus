...
Require Import Lia.
Require Import Location Utils.

Inductive identifier : Type :=
  | Identifier: Location_t  ->  string  -> identifier .
...
Inductive symbol_description : Type :=
  ...
  | SD_unnamed_tag: Location_t -> symbol_description
  ...
  | SD_FunArg: Location_t ->  nat  -> symbol_description .
...
Inductive prefix : Type :=
  | PrefSource:  Location_t  ->  list  sym  -> prefix
  | PrefFunArg:  Location_t  ->  digest  ->  Z  -> prefix
  | PrefStringLiteral:  Location_t  ->  digest  -> prefix
  | PrefTemporaryLifetime: Location_t -> digest -> prefix
  | PrefCompoundLiteral:  Location_t  ->  digest  -> prefix
  | PrefMalloc: prefix

...
(* Extract type *)
Definition extract := (list Id.t * cn_to_extract Symbol.t Ctype.ctype * IndexTerms.t)%type.
...
Inductive statement : Type :=
  ...
  | Instantiate : cn_to_instantiate Symbol.t Ctype.ctype -> IndexTerms.t -> statement

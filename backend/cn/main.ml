      ...
      let result =
        let open Resultat in
         ...
         | Some output_filename ->
            ...
            let (c_function_defs, _c_function_decls, _c_records) = Executable_spec_internal.generate_c_functions_internal ail_prog prog5.mu_logical_predicates in
            ...
            let logical_predicates_without_struct_dependencies = List.filter 
              (fun (_sym, (def : LogicalFunctions.definition)) -> 
            ...
            (fun (_sym, (def : ResourcePredicates.definition)) -> 

...
let generate_c_pres_and_posts (instrumentation : Core_to_mucore.instrumentation) ail_prog =
  ...
  in
  let pres = List.map generate_condition_str instrumentation.requires in
  let posts = List.map generate_condition_str instrumentation.ensures in
...
let generate_c_specs instrumentation_list ail_prog =
  ...
  let generate_c_spec (instrumentation : Core_to_mucore.instrumentation) =
    ...
    let c_statements = generate_c_statements instrumentation.statements in

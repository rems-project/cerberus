...
val get_resource_predicate_def : Locations.t -> Sym.t -> ResourcePredicates.Definition.t m
...
val add_resource_predicate : Sym.t -> ResourcePredicates.Definition.t -> unit m

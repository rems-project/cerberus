...
(** A position in the preprocssed file. The source file and line are
...
(** Source line for position. 1 based *)
val line:   t -> int
...
(** Location in the preprocessed file *)
...
module LineMap : sig
  ...
  (** No source location information. The argument is the name of the
      preprocessed file, which will be used for locations that have no
      additional information. *)
  val empty: string -> t

  (** [add line (srouce_file, souce_line) mp] udpates [mp] with the

...
Definition mem_iv_constraint : Type :=  mem_common.mem_constraint  unit .
Definition mem_iv_constraint_default: mem_iv_constraint  := DAEMON.


Instance x43_Show : Show unit := {
   show   ptrval :=  "TODO"
}.

Instance x42_Show : Show unit := {
   show   mval :=  "TODO"
}.
...
Definition memM (a: Type) : Type := 
  nondeterminism.ndM  a  string   mem_common.mem_error   (mem_common.mem_constraint  unit )  mem_state .

...
Definition translate_errno   : string  -> Z :=  
  fun (x : string ) =>
    match (x) with | "__cerbvar_EDOM" => (Zpred (Zpos (P_of_succ_nat 1)))
      | "__cerbvar_EILSEQ" => (Zpred (Zpos (P_of_succ_nat 2)))
      | "__cerbvar_ERANGE" => (Zpred (Zpos (P_of_succ_nat 3)))
      | "__cerbvar_E2BIG" => (Zpred (Zpos (P_of_succ_nat 4)))
      | "__cerbvar_EACCES" => (Zpred (Zpos (P_of_succ_nat 5)))
      | "__cerbvar_EADDRINUSE" => (Zpred (Zpos (P_of_succ_nat 6)))
      | "__cerbvar_EADDRNOTAVAIL" => (Zpred (Zpos (P_of_succ_nat 7)))
      | "__cerbvar_EAFNOSUPPORT" => (Zpred (Zpos (P_of_succ_nat 8)))
      | "__cerbvar_EAGAIN" => (Zpred (Zpos (P_of_succ_nat 9)))
      | "__cerbvar_EALREADY" => (Zpred (Zpos (P_of_succ_nat 10)))
      | "__cerbvar_EBADF" => (Zpred (Zpos (P_of_succ_nat 11)))
      | "__cerbvar_EBADMSG" => (Zpred (Zpos (P_of_succ_nat 12)))
      | "__cerbvar_EBUSY" => (Zpred (Zpos (P_of_succ_nat 13)))
      | "__cerbvar_ECANCELED" => (Zpred (Zpos (P_of_succ_nat 14)))
      | "__cerbvar_ECHILD" => (Zpred (Zpos (P_of_succ_nat 15)))
      | "__cerbvar_ECONNABORTED" => (Zpred (Zpos (P_of_succ_nat 16)))
      | "__cerbvar_ECONNREFUSED" => (Zpred (Zpos (P_of_succ_nat 17)))
      | "__cerbvar_ECONNRESET" => (Zpred (Zpos (P_of_succ_nat 18)))
      | "__cerbvar_EDEADLK" => (Zpred (Zpos (P_of_succ_nat 19)))
      | "__cerbvar_EDESTADDRREQ" => (Zpred (Zpos (P_of_succ_nat 20)))
      | "__cerbvar_EDQUOT" => (Zpred (Zpos (P_of_succ_nat 21)))
      | "__cerbvar_EEXIST" => (Zpred (Zpos (P_of_succ_nat 22)))
      | "__cerbvar_EFAULT" => (Zpred (Zpos (P_of_succ_nat 23)))
      | "__cerbvar_EFBIG" => (Zpred (Zpos (P_of_succ_nat 24)))
      | "__cerbvar_EHOSTUNREACH" => (Zpred (Zpos (P_of_succ_nat 25)))
      | "__cerbvar_EIDRM" => (Zpred (Zpos (P_of_succ_nat 26)))
      | "__cerbvar_EINPROGRESS" => (Zpred (Zpos (P_of_succ_nat 27)))
      | "__cerbvar_EINTR" => (Zpred (Zpos (P_of_succ_nat 28)))
      | "__cerbvar_EINVAL" => (Zpred (Zpos (P_of_succ_nat 29)))
      | "__cerbvar_EIO" => (Zpred (Zpos (P_of_succ_nat 30)))
      | "__cerbvar_EISCONN" => (Zpred (Zpos (P_of_succ_nat 31)))
      | "__cerbvar_EISDIR" => (Zpred (Zpos (P_of_succ_nat 32)))
      | "__cerbvar_ELOOP" => (Zpred (Zpos (P_of_succ_nat 33)))
      | "__cerbvar_EMFILE" => (Zpred (Zpos (P_of_succ_nat 34)))
      | "__cerbvar_EMLINK" => (Zpred (Zpos (P_of_succ_nat 35)))
      | "__cerbvar_EMSGSIZE" => (Zpred (Zpos (P_of_succ_nat 36)))
      | "__cerbvar_EMULTIHOP" => (Zpred (Zpos (P_of_succ_nat 37)))
      | "__cerbvar_ENAMETOOLONG" => (Zpred (Zpos (P_of_succ_nat 38)))
      | "__cerbvar_ENETDOWN" => (Zpred (Zpos (P_of_succ_nat 39)))
      | "__cerbvar_ENETRESET" => (Zpred (Zpos (P_of_succ_nat 40)))
      | "__cerbvar_ENETUNREACH" => (Zpred (Zpos (P_of_succ_nat 41)))
      | "__cerbvar_ENFILE" => (Zpred (Zpos (P_of_succ_nat 42)))
      | "__cerbvar_ENOBUFS" => (Zpred (Zpos (P_of_succ_nat 43)))
      | "__cerbvar_ENODATA" => (Zpred (Zpos (P_of_succ_nat 44)))
      | "__cerbvar_ENODEV" => (Zpred (Zpos (P_of_succ_nat 45)))
      | "__cerbvar_ENOENT" => (Zpred (Zpos (P_of_succ_nat 46)))
      | "__cerbvar_ENOEXEC" => (Zpred (Zpos (P_of_succ_nat 47)))
      | "__cerbvar_ENOLCK" => (Zpred (Zpos (P_of_succ_nat 48)))
      | "__cerbvar_ENOLINK" => (Zpred (Zpos (P_of_succ_nat 49)))
      | "__cerbvar_ENOMEM" => (Zpred (Zpos (P_of_succ_nat 50)))
      | "__cerbvar_ENOMSG" => (Zpred (Zpos (P_of_succ_nat 51)))
      | "__cerbvar_ENOPROTOOPT" => (Zpred (Zpos (P_of_succ_nat 52)))
      | "__cerbvar_ENOSPC" => (Zpred (Zpos (P_of_succ_nat 53)))
      | "__cerbvar_ENOSR" => (Zpred (Zpos (P_of_succ_nat 54)))
      | "__cerbvar_ENOSTR" => (Zpred (Zpos (P_of_succ_nat 55)))
      | "__cerbvar_ENOSYS" => (Zpred (Zpos (P_of_succ_nat 56)))
      | "__cerbvar_ENOTCONN" => (Zpred (Zpos (P_of_succ_nat 57)))
      | "__cerbvar_ENOTDIR" => (Zpred (Zpos (P_of_succ_nat 58)))
      | "__cerbvar_ENOTEMPTY" => (Zpred (Zpos (P_of_succ_nat 59)))
      | "__cerbvar_ENOTRECOVERABLE" => (Zpred (Zpos (P_of_succ_nat 60)))
      | "__cerbvar_ENOTSOCK" => (Zpred (Zpos (P_of_succ_nat 61)))
      | "__cerbvar_ENOTSUP" => (Zpred (Zpos (P_of_succ_nat 62)))
      | "__cerbvar_ENOTTY" => (Zpred (Zpos (P_of_succ_nat 63)))
      | "__cerbvar_ENXIO" => (Zpred (Zpos (P_of_succ_nat 64)))
      | "__cerbvar_EOPNOTSUPP" => (Zpred (Zpos (P_of_succ_nat 65)))
      | "__cerbvar_EOVERFLOW" => (Zpred (Zpos (P_of_succ_nat 66)))
      | "__cerbvar_EOWNERDEAD" => (Zpred (Zpos (P_of_succ_nat 67)))
      | "__cerbvar_EPERM" => (Zpred (Zpos (P_of_succ_nat 68)))
      | "__cerbvar_EPIPE" => (Zpred (Zpos (P_of_succ_nat 69)))
      | "__cerbvar_EPROTO" => (Zpred (Zpos (P_of_succ_nat 70)))
      | "__cerbvar_EPROTONOSUPPORT" => (Zpred (Zpos (P_of_succ_nat 71)))
      | "__cerbvar_EPROTOTYPE" => (Zpred (Zpos (P_of_succ_nat 72)))
      | "__cerbvar_EROFS" => (Zpred (Zpos (P_of_succ_nat 73)))
      | "__cerbvar_ESPIPE" => (Zpred (Zpos (P_of_succ_nat 74)))
      | "__cerbvar_ESRCH" => (Zpred (Zpos (P_of_succ_nat 75)))
      | "__cerbvar_ESTALE" => (Zpred (Zpos (P_of_succ_nat 76)))
      | "__cerbvar_ETIME" => (Zpred (Zpos (P_of_succ_nat 77)))
      | "__cerbvar_ETIMEDOUT" => (Zpred (Zpos (P_of_succ_nat 78)))
      | "__cerbvar_ETXTBSY" => (Zpred (Zpos (P_of_succ_nat 79)))
      | "__cerbvar_EWOULDBLOCK" => (Zpred (Zpos (P_of_succ_nat 80)))
      | "__cerbvar_EXDEV" => (Zpred (Zpos (P_of_succ_nat 81))) | str =>
      apply BOOM (String.append "Unknown errno code: " str) end.
(* [?]: removed value specification. *)

Definition encode_memory_order    : cmm_csem.memory_order  -> Z :=  
  fun (x : cmm_csem.memory_order ) =>
    match (x) with | cmm_csem.Relaxed => (Zpred (Zpos (P_of_succ_nat 0)))
      | cmm_csem.Consume => (Zpred (Zpos (P_of_succ_nat 1)))
      | cmm_csem.Acquire => (Zpred (Zpos (P_of_succ_nat 2)))
      | cmm_csem.Release => (Zpred (Zpos (P_of_succ_nat 3)))
      | cmm_csem.Acq_rel => (Zpred (Zpos (P_of_succ_nat 4)))
      | cmm_csem.Seq_cst => (Zpred (Zpos (P_of_succ_nat 5))) | cmm_csem.NA =>
      apply BOOM "encode_memory_order NA" end.
(* [?]: removed value specification. *)

Definition decode_memory_order    : nat  -> option (cmm_csem.memory_order ) :=  
  fun (x : nat ) =>
    match (x) with | 0 => apply Some cmm_csem.Relaxed | 1 =>
      apply Some cmm_csem.Consume | 2 => apply Some cmm_csem.Acquire | 3 =>
      apply Some cmm_csem.Release | 4 => apply Some cmm_csem.Acq_rel | 5 =>
      apply Some cmm_csem.Seq_cst | _ => None end.
(* [?]: removed value specification. *)

Definition translate_builtin_varnames  (c : cabs.cabs_identifier )  : option (expression_ (unit )) := 
  match ( (c)) with (( cabs.CabsIdentifier _ str)) =>
  ...
  match ( str) with (* stddef.h *) | "__cerbvar_NULL" =>
    ...
    apply const_ic (encode_memory_order cmm_csem.Relaxed)
    | "__cerbvar_memory_order_consume" =>
    apply const_ic (encode_memory_order cmm_csem.Consume)
    | "__cerbvar_memory_order_acquire" =>
    apply const_ic (encode_memory_order cmm_csem.Acquire)
    | "__cerbvar_memory_order_release" =>
    apply const_ic (encode_memory_order cmm_csem.Release)
    | "__cerbvar_memory_order_acq_rel" =>
    apply const_ic (encode_memory_order cmm_csem.Acq_rel)
    | "__cerbvar_memory_order_seq_cst" =>
    apply const_ic (encode_memory_order cmm_csem.Seq_cst)
  ...
  (* stdint.h *) | "__cerbvar_CHAR_BIT" =>
    (* TODO/FIXME: this depends on the implementation *) const_ic
      ((Zpred (Zpos (P_of_succ_nat 8)))) | "__cerbvar_SCHAR_MIN" =>

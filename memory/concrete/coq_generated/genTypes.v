...
Inductive genType : Type := 
 ...
 | GenStruct:  ail_identifier  -> genType 
 | GenUnion:  ail_identifier  -> genType 
...
Instance x67_Eq : Eq genIntegerType := {
...
Instance x66_Eq : Eq genBasicType := {
...
Definition eq_genType  (gty1 : genType ) (gty2 : genType )  : bool := 
  ...
  match ( (gty1, gty2)) with 
    ...
    | (GenStruct tag1,  GenStruct tag2) => symbol.symbolEqual0
        tag1 tag2
    | (GenUnion tag1,  GenUnion tag2) => symbol.symbolEqual0
        tag1 tag2
...
Instance x64_Eq : Eq genTypeCategory := {

...
Instance x60_Show : Show mem_error := {
   show  :=  fun x =>
...
Definition mem_constraint_default{a: Type} : mem_constraint a := MC_empty.

Instance x58_Constraints{a: Type} : Constraints mem_constraint  a:= {
   empty  :=  MC_empty;
   negate   cs :=  MC_not cs;

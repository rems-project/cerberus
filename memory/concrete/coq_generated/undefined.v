...
Definition ub_str_bimap   : bimap.bimap (undefined_behaviour ) (string ):= 
  bimap.fromList0
    ...
    match (x) with | DUMMY str =>
      ...
      match ( bimap.lookupL ub ub_str_bimap) with | Some str => str | None =>
        match ( ub) with | Invalid_format str =>
          ...
          BOOM "Undefined.stringFromUndefined_behaviour" end end end.

Instance x46_Show : Show undefined_behaviour := {
...
Definition t0_default{a: Type} : t0 a := Defined DAEMON.
(* [?]: removed value specification. *)

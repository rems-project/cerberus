(* Generated by Lem from ocaml_generated/implementation.lem. *)
...
Inductive implementation_constant : Type := 
  (* J.3.2 Environment *)
  ...
  | Environment__startup_name: implementation_constant 
  | Environment__startup_type: implementation_constant 
  ...
  | Characters__bits_in_byte: implementation_constant 
  
  (* The values of the members of the execution character set (5.2.1). *)
  | Characters__execution_character_set_values: implementation_constant 
  ...
  | Characters__TODO1: implementation_constant 
  ...
  | Characters__TODO2: implementation_constant 
  
  (* Which of signed char or unsigned char has the same range, representation, and
     behavior as ââplainââ char (6.2.5, 6.3.1.1). *)
  | Characters__plain_char_is_signed: implementation_constant 
    (* TODO: others *)
  ...
  (* The mapping of members of the source character set (in character constants
     ...
     (6.4.4.4, 5.1.1.2). *)
  | Characters__TODO3: implementation_constant 
  ...
  | Characters__TODO4: implementation_constant 
  ...
  (* The value of a wide character constant containing more than one multibyte
     ...
     (6.4.4.4). *)
  | Characters__TODO5: implementation_constant 
  ...
  | Characters__TODO6: implementation_constant 
  ...
  | Characters__TODO9: implementation_constant 
  ...
  | Characters__TODO10: implementation_constant 
  ...
  (* Whether signed integer types are represented using sign and magnitude, twoâs complement, or
     onesâ complement, and whether the extraordinary value is a trap representation or an ordinary
     value (6.2.6.2). *)
  ...
  | Integer__encode: implementation_constant  (* function taking an integer type and an integer and returning a non-negative integer
                       modeling the proper binary representation *)
  | Integer__decode: implementation_constant  (* the other way around *)
  ...
  | Integer__conv_nonrepresentable_signed_integer: implementation_constant 
  
  (* The results of some bitwise operations on signed integers (6.5). *)
  (* TODO: will have several Ctors *)
  | Sizeof: implementation_constant 
  | Alignof: implementation_constant 
  | SHR_signed_negative: implementation_constant 
  | Bitwise_complement: implementation_constant 
  ...
  (* Whether a ââplainââ int bit-field is treated as a signed int bit-field or
     as an unsigned int bit-field (6.7.2, 6.7.2.1). *)
  | Plain_bitfield_sign: implementation_constant 
  
  (* Allowable bit-field types other than _Bool, signed int, and unsigned int
     (6.7.2.1). *)
  | Bitfield_other_types: implementation_constant 
  
  (* Whether atomic types are permitted for bit-fields (6.7.2.1). *)
  |  Atomic_bitfield_permitted: implementation_constant 
...
(* TODO: PRESENT BETTER *)
  | Ctype_min: implementation_constant 
  | Ctype_max: implementation_constant 
  
  (* Builtin functions *)
  | BuiltinFunction:  string  -> implementation_constant .
Definition implementation_constant_default: implementation_constant  := Environment__startup_name.
(* [?]: removed value specification. *)

Definition implementation_constant_to_nat  (x : implementation_constant )  : nat := 
  match ( x) with 
...
Definition implementation_constant_equal  (x : implementation_constant ) (y : implementation_constant )  : bool := 
  match ( (x, y)) with 
    | (BuiltinFunction name1,  BuiltinFunction name2) => ( (string_equal name1 name2))
    | _ => ( beq_nat(implementation_constant_to_nat x) (implementation_constant_to_nat y))
  end.

Instance x27_Eq : Eq implementation_constant := {
   isEqual  :=  implementation_constant_equal;
   isInequal   x  y :=  negb (implementation_constant_equal x y)
}.


Definition implementation_constant_compare  (x : implementation_constant ) (y : implementation_constant )  : ordering := 
  match ( (x, y)) with 
    | (BuiltinFunction name1,  BuiltinFunction name2) => EQ
    | _ => (genericCompare nat_ltb beq_nat (implementation_constant_to_nat x) (implementation_constant_to_nat y))
  end. 

Instance x26_SetType : SetType implementation_constant := {
   setElemCompare  :=  implementation_constant_compare
}.


(* TODO: this is for the parsing (a bit disgusting to do it that way *)
Definition impl_map   : fmap (string ) (implementation_constant ):= 
  List.fold_left (fun (acc : fmap (string ) (implementation_constant )) (p : (string *implementation_constant ) % type) =>
  match ( (acc ,p) ) with ( acc ,  (k,  v)) => fmap_add k v acc end) [
...
Definition string_of_implementation_constant   : implementation_constant  -> string :=  
  fun (x : implementation_constant ) =>
    match (x) with | Environment__startup_name => "Environment.startup_name"
      | Environment__startup_type => "Environment.startup_type"
      | Characters__bits_in_byte => "Characters.bits_in_byte"
      | Characters__execution_character_set_values =>
      "Characters.execution_character_set_values" | Characters__TODO1 =>
      "Characters.TODO1" | Characters__TODO2 => "Characters.TODO2"
      | Characters__plain_char_is_signed => "Characters.plain_char_is_signed"
      | Characters__TODO3 => "Characters.TODO3" | Characters__TODO4 =>
      "Characters.TODO4" | Characters__TODO5 => "Characters.TODO5"
      | Characters__TODO6 => "Characters.TODO6" | Characters__TODO7 =>
      "Characters.TODO7" | Characters__TODO8 => "Characters.TODO8"
      | Characters__TODO9 => "Characters.TODO9" | Characters__TODO10 =>
      "Characters.TODO10" | Integer__encode => "Integer.encode"
      | Integer__decode => "Integer.decode"
      | Integer__conv_nonrepresentable_signed_integer =>
      "Integer.conv_nonrepresentable_signed_integer" | Sizeof => "sizeof"
      | Alignof => "alignof" | SHR_signed_negative => "SHR_signed_negative"
      | Bitwise_complement => "Bitwise_complement" | Plain_bitfield_sign =>
      "Plain_bitfield_sign" | Bitfield_other_types => "Bitfield_other_types"
      | Atomic_bitfield_permitted => "Atomic_bitfield_permitted"
      | Ctype_min => "ctype_min" | Ctype_max => "ctype_max"
      | BuiltinFunction fname => String.append "builtin_" fname end.

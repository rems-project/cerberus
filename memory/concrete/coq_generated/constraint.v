...
Inductive violation : Type := 
  ...
  | MemberofNoMemberLvalue:  identifier  ->  qualifiers  ->  ctype  -> violation  (* Â§6.5.2.3#1 *)
  | MemberofNoMemberRvalue:  identifier  ->  genType  -> violation  (* Â§6.5.2.3#1 *)
  ...
  | MemberofptrNoMember:  identifier  ->  qualifiers  ->  ctype  -> violation  (* Â§6.5.2.3#2 *)
  ...
  (* 6.7 Declarations *)
  | NoLinkageMultipleDeclaration:  identifier  -> violation  (* Â§6.7#3 *)
  ...
  | StructMemberFunctionType:  identifier  -> violation  (* Â§6.7.2.1#3, sentence 1 *)
  ...
  | LabelRedefinition:  identifier  -> violation  (* Â§6.8.1#3 *)
  ...
  | UndeclaredLabel:  identifier  -> violation  (* Â§6.8.6.1#1, sentence 1 *)
...
Definition assignment_violation_default: assignment_violation  := (fun (x68 : 
  simple_assignment_violation ) => (fun (x69 :  ctype ) => (fun (x70 :  genType ) => violation_default))).

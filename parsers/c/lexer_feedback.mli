...
val create_function_definition: Location_ocaml.t -> Annot.attributes(*((((Symbol.identifier option * Symbol.identifier) * ((string list) option)) list) list) option*) -> Cabs.specifiers ->
  declarator -> Cabs.cabs_statement -> Cabs.declaration0 list option ->
  Cabs.cabs_function_definition

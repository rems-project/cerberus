...
let rec coq_Pminus_mask x y =
  ...
  | Coq_xO p ->
    (match y with
     | Coq_xI q -> coq_Pdouble_plus_one_mask (coq_Pminus_mask_carry p q)
...
and coq_Pminus_mask_carry x y =
  ...
  | Coq_xO p ->
    (match y with
     ...
     | Coq_xO q -> coq_Pdouble_plus_one_mask (coq_Pminus_mask_carry p q)
...
| PeanoSucc (p0, q0) ->
  PeanoSucc ((coq_Psucc (Coq_xO p0)), (PeanoSucc ((Coq_xO p0),
    (peanoView_xO p0 q0))))

(** val peanoView_xI : positive -> coq_PeanoView -> coq_PeanoView **)

let rec peanoView_xI p = function
| PeanoOne -> PeanoSucc ((coq_Psucc Coq_xH), (PeanoSucc (Coq_xH, PeanoOne)))
| PeanoSucc (p0, q0) ->
  PeanoSucc ((coq_Psucc (Coq_xI p0)), (PeanoSucc ((Coq_xI p0),
    (peanoView_xI p0 q0))))

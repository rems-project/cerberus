...
module Gram : 
 sig 
  ...
  and parse_tree_list =
    | Nil_ptl
    | Cons_ptl of token list * symbol * symbol_semantic_type * 
       parse_tree * token list * symbol list * tuple * 
       parse_tree_list
 ...
 sig 
  module Inter : 
   sig 
    ...
    type stack =
      | Nil_stack
      | Cons_stack of Aut.noninitstate * Aut.Gram.symbol_semantic_type
         * stack
         ...
         sig 
          module Raw : 
           sig 
            ...
            type tree =
              | Leaf
              | Node of tree * TerminalOrderedType.Alt.t * 
                 tree * Z_as_Int.int
            ...
            type coq_R_remove_min =
              ...
              | R_remove_min_1 of tree * elt * t * 
                 tree * TerminalOrderedType.Alt.t * 
                 tree * Z_as_Int.int * (t*elt) * coq_R_remove_min * 
                 t * elt
            ...
            type coq_R_concat =
              ...
              | R_concat_1 of tree * tree * tree * 
                 TerminalOrderedType.Alt.t * tree * 
                 Z_as_Int.int
              | R_concat_2 of tree * tree * tree * 
                 TerminalOrderedType.Alt.t * tree * 
                 Z_as_Int.int * tree * TerminalOrderedType.Alt.t * 
                 tree * Z_as_Int.int * t * elt
         ...
         sig 
          ...
          module Proofs : 
           sig 
            ...
            type 'elt coq_R_mem =
              | R_mem_0 of 'elt tree
              | R_mem_1 of 'elt tree * 'elt tree * 
                 key * 'elt * 'elt tree * Z_as_Int.int * 
                 bool * 'elt coq_R_mem
              | R_mem_2 of 'elt tree * 'elt tree * 
                 key * 'elt * 'elt tree * Z_as_Int.int
              | R_mem_3 of 'elt tree * 'elt tree * 
                 key * 'elt * 'elt tree * Z_as_Int.int * 
                 bool * 'elt coq_R_mem
            ...
            type 'elt coq_R_find =
              ...
              | R_find_1 of 'elt tree * 'elt tree * 
                 key * 'elt * 'elt tree * Z_as_Int.int * 
                 'elt option * 'elt coq_R_find
              | R_find_2 of 'elt tree * 'elt tree * 
                 key * 'elt * 'elt tree * Z_as_Int.int
              | R_find_3 of 'elt tree * 'elt tree * 
                 key * 'elt * 'elt tree * Z_as_Int.int * 
                 'elt option * 'elt coq_R_find
            ...
            type 'elt coq_R_bal =
              ...
              | R_bal_1 of 'elt tree * key * 'elt * 
                 'elt tree * 'elt tree * key * 'elt * 
                 'elt tree * Z_as_Int.int
              | R_bal_2 of 'elt tree * key * 'elt * 
                 'elt tree * 'elt tree * key * 'elt * 
                 'elt tree * Z_as_Int.int
              | R_bal_3 of 'elt tree * key * 'elt * 
                 'elt tree * 'elt tree * key * 'elt * 
                 'elt tree * Z_as_Int.int * 'elt tree * 
                 key * 'elt * 'elt tree * Z_as_Int.int
              | R_bal_4 of 'elt tree * key * 'elt * 'elt tree
              | R_bal_5 of 'elt tree * key * 'elt * 
                 'elt tree * 'elt tree * key * 'elt * 
                 'elt tree * Z_as_Int.int
              | R_bal_6 of 'elt tree * key * 'elt * 
                 'elt tree * 'elt tree * key * 'elt * 
                 'elt tree * Z_as_Int.int
              | R_bal_7 of 'elt tree * key * 'elt * 
                 'elt tree * 'elt tree * key * 'elt * 
                 'elt tree * Z_as_Int.int * 'elt tree * 
                 key * 'elt * 'elt tree * Z_as_Int.int
            ...
            type 'elt coq_R_add =
              | R_add_0 of 'elt tree
              | R_add_1 of 'elt tree * 'elt tree * 
                 key * 'elt * 'elt tree * Z_as_Int.int * 
                 'elt tree * 'elt coq_R_add
              | R_add_2 of 'elt tree * 'elt tree * 
                 key * 'elt * 'elt tree * Z_as_Int.int
              | R_add_3 of 'elt tree * 'elt tree * 
                 key * 'elt * 'elt tree * Z_as_Int.int * 
                 'elt tree * 'elt coq_R_add
            ...
            type 'elt coq_R_remove_min =
              ...
              | R_remove_min_1 of 'elt tree * key * 
                 'elt * 'elt tree * 'elt tree * key * 
            ...
            type ('elt, 'elt', 'elt'') coq_R_map2_opt =
              ...
              | R_map2_opt_2 of 'elt tree * 'elt' tree * 
                 'elt tree * key * 'elt * 'elt tree * 
                 Z_as_Int.int * 'elt' tree * key * 
                 'elt' * 'elt' tree * Z_as_Int.int * 
                 'elt' tree * 'elt' option * 'elt' tree * 

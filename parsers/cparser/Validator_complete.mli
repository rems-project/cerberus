...
module Make : 
 ...
 sig 
     ...
     sig 
      module Raw : 
       sig 
        ...
        val assert_false : tree -> TerminalOrderedType.Alt.t -> tree -> tree
        ...
        val elements_aux :
          TerminalOrderedType.Alt.t list -> t -> TerminalOrderedType.Alt.t
          list
        ...
        | R_remove_min_1 of tree * elt * t * tree * TerminalOrderedType.Alt.t
           * tree * Z_as_Int.int * (t, elt) prod * coq_R_remove_min * 
           t * elt
        ...
        | R_merge_2 of tree * tree * tree * TerminalOrderedType.Alt.t * 
           tree * Z_as_Int.int * tree * TerminalOrderedType.Alt.t * tree
           * Z_as_Int.int * t * elt
        
        type coq_R_min_elt =
        | R_min_elt_0 of tree
        | R_min_elt_1 of tree * tree * TerminalOrderedType.Alt.t * tree
           * Z_as_Int.int
        | R_min_elt_2 of tree * tree * TerminalOrderedType.Alt.t * tree
           * Z_as_Int.int * tree * TerminalOrderedType.Alt.t * tree
           * Z_as_Int.int * TerminalOrderedType.Alt.t option * coq_R_min_elt
        
        type coq_R_max_elt =
        | R_max_elt_0 of tree
        | R_max_elt_1 of tree * tree * TerminalOrderedType.Alt.t * tree
           * Z_as_Int.int
        | R_max_elt_2 of tree * tree * TerminalOrderedType.Alt.t * tree
           * Z_as_Int.int * tree * TerminalOrderedType.Alt.t * tree
           * Z_as_Int.int * TerminalOrderedType.Alt.t option * coq_R_max_elt
        ...
        | R_inter_2 of tree * tree * tree * TerminalOrderedType.Alt.t * 
           tree * Z_as_Int.int * tree * TerminalOrderedType.Alt.t * tree
           * Z_as_Int.int * t * bool * t * tree * coq_R_inter * tree
           * coq_R_inter
        ...
        | R_diff_2 of tree * tree * tree * TerminalOrderedType.Alt.t * 
           tree * Z_as_Int.int * tree * TerminalOrderedType.Alt.t * tree
           * Z_as_Int.int * t * bool * t * tree * coq_R_diff * tree
           * coq_R_diff
        ...
        | R_union_2 of tree * tree * tree * TerminalOrderedType.Alt.t * 
           tree * Z_as_Int.int * tree * TerminalOrderedType.Alt.t * tree
           * Z_as_Int.int * t * bool * t * tree * coq_R_union * tree
           * coq_R_union
   ...
   sig 
    ...
    module Raw : 
     sig 
      ...
      val equal_more :
        ('a1 -> 'a1 -> bool) -> StatePseudoprodPosOrderedType.Alt.t -> 'a1 ->
       ...
       sig 
        ...
        module L : 
         sig 
          ...
          type 'elt t = (StatePseudoprodPosOrderedType.Alt.t, 'elt) prod list
          ...
          | R_mem_1 of 'elt t * StatePseudoprodPosOrderedType.Alt.t * 
             'elt * (StatePseudoprodPosOrderedType.Alt.t, 'elt) prod list
          ...
          val coq_R_mem_rect :
            ...
            (StatePseudoprodPosOrderedType.Alt.t, 'a1) prod list -> __ -> __
            -> __ -> 'a2) -> ('a1 t -> StatePseudoprodPosOrderedType.Alt.t ->
            'a1 -> (StatePseudoprodPosOrderedType.Alt.t, 'a1) prod list -> __
            -> __ -> __ -> 'a2) -> ('a1 t ->
            StatePseudoprodPosOrderedType.Alt.t -> 'a1 ->
            (StatePseudoprodPosOrderedType.Alt.t, 'a1) prod list -> __ -> __
          ...
          val fold_rect :
            ...
            (__ -> (key -> 'a1 -> __ -> __) -> 'a1 t -> __ ->
            StatePseudoprodPosOrderedType.Alt.t -> 'a1 ->
            (StatePseudoprodPosOrderedType.Alt.t, 'a1) prod list -> __ -> 'a2
          ...
          val coq_R_equal_rect :
            ...
            ('a1 t -> 'a1 t -> StatePseudoprodPosOrderedType.Alt.t -> 'a1 ->
            ...
            StatePseudoprodPosOrderedType.Alt.t -> 'a1 ->
            (StatePseudoprodPosOrderedType.Alt.t, 'a1) prod list -> __ ->
            StatePseudoprodPosOrderedType.Alt.t OrderedType.coq_Compare -> __
  ...
  val find_items_map : A.state -> A.pseudoprod -> nat -> TerminalSet.t

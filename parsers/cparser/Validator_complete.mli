       ...
       sig 
        ...
        type coq_R_inter =
          ...
          | R_inter_2 of tree * tree * tree * TerminalOrderedType.Alt.t
             * tree * Z_as_Int.int * tree * TerminalOrderedType.Alt.t * 
             tree * Z_as_Int.int * t * bool * t * tree * 
       ...
       sig 
        ...
        type 'elt coq_R_remove_min =
          ...
          | R_remove_min_1 of 'elt tree * key * 'elt * 
             'elt tree * 'elt tree * key * 'elt * 'elt tree * 
        ...
        type 'elt coq_R_remove =
          ...
          | R_remove_1 of 'elt tree * 'elt tree * key * 
             'elt * 'elt tree * Z_as_Int.int * 'elt tree * 
             'elt coq_R_remove
          | R_remove_2 of 'elt tree * 'elt tree * key * 
             'elt * 'elt tree * Z_as_Int.int
          | R_remove_3 of 'elt tree * 'elt tree * key * 
             'elt * 'elt tree * Z_as_Int.int * 'elt tree * 
             'elt coq_R_remove
        ...
        type 'elt coq_R_split =
          ...
          | R_split_1 of 'elt tree * 'elt tree * key * 
             'elt * 'elt tree * Z_as_Int.int * 'elt triple * 
             'elt coq_R_split * 'elt tree * 'elt option * 
             'elt tree
          | R_split_2 of 'elt tree * 'elt tree * key * 
             'elt * 'elt tree * Z_as_Int.int
          | R_split_3 of 'elt tree * 'elt tree * key * 
             'elt * 'elt tree * Z_as_Int.int * 'elt triple * 
             'elt coq_R_split * 'elt tree * 'elt option * 
             'elt tree
        ...
        type ('elt, 'elt', 'elt'') coq_R_map2_opt =
          ...
          | R_map2_opt_2 of 'elt tree * 'elt' tree * 
             ...
             Z_as_Int.int * 'elt' tree * 'elt' option * 

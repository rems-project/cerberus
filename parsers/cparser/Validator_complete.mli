      ...
      module Raw : 
       sig 
        ...
        | R_remove_min_1 of tree * elt * t * tree * TerminalOrderedType.Alt.t
           * tree * Z_as_Int.int * (t*elt) * coq_R_remove_min * t * elt
        ...
        module L : 
         sig 
          ...
          val coq_R_mem_rect :
            ...
            (StatePseudoprodPosOrderedType.Alt.t*'a1) list -> __ -> __ -> __
            -> 'a2) -> ('a1 t -> StatePseudoprodPosOrderedType.Alt.t -> 'a1
            -> (StatePseudoprodPosOrderedType.Alt.t*'a1) list -> __ -> __ ->
            __ -> 'a2) -> ('a1 t -> StatePseudoprodPosOrderedType.Alt.t ->
            'a1 -> (StatePseudoprodPosOrderedType.Alt.t*'a1) list -> __ -> __

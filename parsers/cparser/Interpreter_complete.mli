...
module Make : 
 ...
 sig 
        ...
        module Proofs : 
         sig 
          ...
          val coq_R_mem_rect :
            ...
            tree -> Z_as_Int.int -> __ -> __ -> __ -> bool -> 'a1 coq_R_mem
          ...
          val coq_R_merge_rect :
            ...
            tree -> Z_as_Int.int -> __ -> 'a1 tree -> key -> 'a1 -> 'a1 tree
          ...
          val coq_R_concat_rect :
            ...
            'a2) -> ('a1 tree -> 'a1 tree -> 'a1 tree -> key -> 'a1 -> 'a1
            tree -> Z_as_Int.int -> __ -> 'a1 tree -> key -> 'a1 -> 'a1 tree
            -> Z_as_Int.int -> __ -> 'a1 tree -> (key, 'a1) prod -> __ ->
          ...
          val coq_R_map_option_rect :
            ...
            tree -> 'a1 tree -> key -> 'a1 -> 'a1 tree -> Z_as_Int.int -> __
            -> __ -> 'a2 tree -> ('a1, 'a2) coq_R_map_option -> 'a3 -> 'a2
          ...
          val coq_R_map2_opt_rect :
            ...
            tree -> Z_as_Int.int -> __ -> __ -> 'a4) -> ('a1 tree -> 'a2 tree
            -> 'a1 tree -> key -> 'a1 -> 'a1 tree -> Z_as_Int.int -> __ ->
            'a2 tree -> key -> 'a2 -> 'a2 tree -> Z_as_Int.int -> __ -> 'a2
            tree -> 'a2 option -> 'a2 tree -> __ -> 'a3 -> __ -> 'a3 tree ->
            ('a1, 'a2, 'a3) coq_R_map2_opt -> 'a4 -> 'a3 tree -> ('a1, 'a2,
            'a3) coq_R_map2_opt -> 'a4 -> 'a4) -> ('a1 tree -> 'a2 tree ->
            'a1 tree -> key -> 'a1 -> 'a1 tree -> Z_as_Int.int -> __ -> 'a2
            tree -> key -> 'a2 -> 'a2 tree -> Z_as_Int.int -> __ -> 'a2 tree
            -> 'a2 option -> 'a2 tree -> __ -> __ -> 'a3 tree -> ('a1, 'a2,
  ...
  val extend_stack : Inter.stack -> A.noninitstate list -> __ -> Inter.stack
  ...
  val hole_future_invariant_rect :
    bool -> ((A.Gram.symbol list, tuple) sigT -> __ -> A.GramDefs.token list
    -> A.GramDefs.parse_tree_list -> (A.Gram.production, tuple) sigT option
    -> 'a1) -> hole_future_invariant -> 'a1

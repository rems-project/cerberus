...
for name in $OC_CASES; do 
  ...
  echo -e "Coq M2R"; time $M2R -mem2reg $OC_DIR$name"/test.bc" >& $name"o.ll"
  llvm-as -f $name"o.ll" -o $name"o.bc"
  echo -e "LLVM ld1"; time llvm-ld -native -lm $LD_FLAG $name"o.bc" -o $name"a.exe"

  echo -e "Coq M2R no phielim"; time $M2R -mem2reg-no-phi-elim $OC_DIR$name"/test.bc" >& $name"o.ll"
  llvm-as -f $name"o.ll" -o $name"o.bc"
  echo -e "LLVM ld2"; time llvm-ld -native -lm $LD_FLAG $name"o.bc" -o $name"c.exe"
 
  echo -e "LLVM ld3"; time llvm-ld -native -lm $LD_FLAG $OC_DIR$name"/test.bc" -o $name"b.exe"
done;
...
for name in $S95_CASES; do 
  ...
  echo -e "Coq M2R"; time $M2R -mem2reg $S95_DIR$name"/src/test.bc" >& $name"o.ll"
  llvm-as -f $name"o.ll" -o $name"o.bc"
  echo -e "LLVM ld1"; time llvm-ld -native -lm $LD_FLAG $name"o.bc" -o $name"a.exe"

  echo -e "Coq M2R no phielim"; time $M2R -mem2reg-no-phi-elim $S95_DIR$name"/src/test.bc" >& $name"o.ll"
  llvm-as -f $name"o.ll" -o $name"o.bc"
  echo -e "LLVM ld2"; time llvm-ld -native -lm $LD_FLAG $name"o.bc" -o $name"c.exe"
 
  echo -e "LLVM ld3"; time llvm-ld -native -lm $LD_FLAG $S95_DIR$name"/src/test.bc" -o $name"b.exe"
done;

...
val foldmap: (document -> document -> document) -> ('a -> document) -> 'a list -> document
...
val sep0map: document -> ('a -> document) -> 'a list -> document

val comma_list : ('a -> document) -> 'a list -> document
...
module Formatter : RENDERER with type channel = Format.formatter

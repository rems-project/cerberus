...
(** [transform_file strict_reads file] returns [file] where [Proc _] in
    [file.funs] has some function-local variables promoted, i.e.
    the body has some series of creates, stores, loads, and kills
    replaced with pure variable bindings. The behaviour of the replaced
    loads raises UB011 if [strict_reads = true]. It calls [analyse_file] to
    determine which variables are promotable. *)
val transform_file : strict_reads:bool -> unit Core.file -> unit Core.file
